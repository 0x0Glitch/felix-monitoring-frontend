    ...
    if (isAllTime) {
      ...
      query = `
        SELECT
          ...
          AVG(bid_depth_5bps) as bid_depth_5bps,
          AVG(ask_depth_5bps) as ask_depth_5bps,
          AVG(bid_depth_10bps) as bid_depth_10bps,
          AVG(ask_depth_10bps) as ask_depth_10bps,
          AVG(bid_depth_50bps) as bid_depth_50bps,
          AVG(ask_depth_50bps) as ask_depth_50bps,
          AVG(bid_depth_100bps) as bid_depth_100bps,
          AVG(ask_depth_100bps) as ask_depth_100bps,
          AVG(bid_depth_5bps + ask_depth_5bps) as total_depth_5bps,
          AVG(bid_depth_10bps + ask_depth_10bps) as total_depth_10bps,
          AVG(bid_depth_50bps + ask_depth_50bps) as total_depth_50bps,
          AVG(bid_depth_100bps + ask_depth_100bps) as total_depth_100bps,
          MIN(coin) as coin
        FROM ${fullTableName}
